...
public class SecurityOauth2Test {
  Logger log = LoggerFactory.getLogger(SecurityOauth2Test.class);
  // 端口
  ...
  // 获取accessToken的URI
  final static String TOKEN_REQUEST_URI =
      "http://127.0.0.1:" + PORT + "/oauth/token?grant_type=password&username=" + USERNAME
          + "&password=" + PASSWORD + "&scope=all";
  // 获取用户信息得URL
  ...
  public void signInTest() throws Exception {
    ...
    // getForObject
    ResponseEntity<String> result =
        rest.exchange(SIGN_IN_URI, HttpMethod.POST, entity, String.class, new Object[] {null});
